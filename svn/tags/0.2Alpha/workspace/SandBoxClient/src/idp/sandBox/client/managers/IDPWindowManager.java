...
public class IDPWindowManager {
	 ...
	 * Toolbar button for JXMLTreeToolBar. 
	 */
	static private JButton jToolBarButtonColors 	= null;
	
	/**
	 * Add new tag button.
	 * Tool bar button for JXMLTreeToolBar. 
	 */
	...
	/**
	 * Used to save toolbar background color.
	 */
	...
	/**
	 * Choose Colors Dialog menu item
	 */
	...
	static private JScrollPane getJXMLTreeScrollPane() {
		if (jXMLTreeScrollPane == null) {
			...
			preferredSize.height = IDPClientSingleton.getIDPClient().getScreenHeight();
		...
		if (jTabbedPane == null) {
			...
			jTabbedPane.addCloseEventListener(new CloseEventListener()
			{
				...
				public void closeTab(MouseEvent e, int tabIndex) {
					...
					{
						int result = JOptionPane.showConfirmDialog(null, "Document was changed. Save the changes?", "Closing", JOptionPane.YES_NO_CANCEL_OPTION);
						
						if (result == JOptionPane.YES_OPTION) // save before closing
						{
							client.saveCurrentXML(); 
						}
						else if (result == JOptionPane.CANCEL_OPTION) // don't close
						{
							return;
						}
					}
	...
	static private JButton getJButtonConnect() {
		if (jButtonConnect == null) {
			...
			if (imageURL != null)
			{
				...
				imageConnect = imageConnect.getScaledInstance(
			...
			imageURL = SandBoxClient.class
					.getResource(Constants.resourcePath + "/Disconnect.png");
			
			if (imageURL != null)
			{
				imageDisconnect = Toolkit.getDefaultToolkit().getImage(imageURL);
				imageDisconnect = imageDisconnect.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
	...
	static public void connectToServer()
	{
		try
		{
			...
			if (connection == null)
			{
				//JOptionPane.showMessageDialog(null,"Couldn't connect to server!!!", "Connection", JOptionPane.WARNING_MESSAGE);
				client.glassPaneFadeIn(IDPGlassPane.IDPDialogs.MessageDialog,"Error","Couldn't connect to the server", IDPMessageDlg.messageType.ERROR_MESSAGE);
				return;
			}
			////////////////////////////////////////////////////////
			...
			if (connection.isTrainCompleted() == true) jButtonApply.setEnabled(true);
			...
			if (connection.isTrainCompleted() == true) applyMenuItem.setEnabled(true);
	...
	static private JButton getJButtonTrain() {
		if (jButtonTrain == null) {
			...
			if (imageURL != null)
			{
				...
				imageTrain = imageTrain.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
	...
	static public void train()
	{
		...
		jStatusLabel
				.setText("Sending train command to server");
		try {
			...
			/////////////////////////////////////////////////////////
			// going to synchronous mode, all asynchronous work is done by server
			...
			{
				e.printStackTrace();
				System.out.println("[Error] Couldn't find train directory. Check your project properties.");
				jStatusLabel.setText("Couldn't find train directory. Check your project properties.");
			...
			/////////////////////////////////////////////////////////
			// Create thread for train operation and for progress bar state changing
	...
	static private JButton getJButtonApply() {
		if (jButtonApply == null) {
			...
			if (imageURL != null)
			{
				...
				imageApply = imageApply.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
	...
	{
		System.out.println("Sending apply command to server");
		jStatusLabel
				.setText("Sending apply command to server");
		try {
			...
			{
				e.printStackTrace();
				System.out.println("[Error] Couldn't find apply directory. Check your project properties.");
				jStatusLabel.setText("Couldn't find apply directory. Check your project properties.");
				IDPClientSingleton.getIDPClient().glassPaneFadeIn(IDPGlassPane.IDPDialogs.MessageDialog,"Error",
			...
			////////////////////////////////////////////////////////
			// Create thread for apply operation and for progress bar state changing
	...
	static public void retrain()
	{
		...
		jStatusLabel
				.setText("Sending retrain and apply commands to server");
		try {
			...
			/////////////////////////////////////////////////////////
			// Create thread for train-apply operation and for progress bar state changing
			Thread threadProgressBar = new Thread(
					progressCounter);
			threadProgressBar.start();
			/////////////////////////////////////////////////////////
...
//			JOptionPane.showMessageDialog(null, "Couldn't get respond from the server.\n"+
	...
	static public JButton getJButtonSaveChanges() {
		if (jButtonSaveXML == null) {
			...
			if (imageURL != null)
			{
				...
				imageSave = imageSave.getScaledInstance(
						rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
			
			jButtonSaveXML = new JButton("Save changes", new ImageIcon(imageSave));
	...
	static private JButton getJButtonChooseColors() {
		if (jButtonChooseColor == null) {
			...
			if (imageURL != null)
			{
				imageChooseColors = Toolkit.getDefaultToolkit().getImage(imageURL);
				imageChooseColors = imageChooseColors.getScaledInstance(
						rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
			
			jButtonChooseColor = new JButton("Colors...", new ImageIcon(imageChooseColors));
	...
	static private JButton getJButtonSettings() {
		if (jButtonSettings == null) {
			...
			if (imageURL != null)
			{
				...
				imageSettings = imageSettings.getScaledInstance(
						rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
			
			jButtonSettings = new JButton("Settings", new ImageIcon(imageSettings));
	...
	static private JButton getJButtonProperties() {
		if (jButtonProperties == null) {
			...
			if (imageURL != null)
			{
				...
				imageProperties = imageProperties.getScaledInstance(
						rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
			
			jButtonProperties = new JButton("Properties", new ImageIcon(imageProperties));
	...
	static private JButton getJButtonTest() {
		if (jButtonTest == null) {
			...
			if (imageURL != null)
			{
				...
				imageExit = imageExit.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
			
			jButtonTest = new JButton("Server console", new ImageIcon(imageExit));
	...
	static private JMenuItem getConnectMenuItem()
	{
		...
		if (imageURL != null)
		{
			...
			{
				imageConnectMenu = imageConnectMenu.getScaledInstance(
		...
		if (imageURL != null)
		{
			imageDisconnectMenu = Toolkit.getDefaultToolkit().getImage(imageURL);
			if (withLargeMenu == false) // resize
			{
				imageDisconnectMenu = imageDisconnectMenu.getScaledInstance(
					16, 16, java.awt.Image.SCALE_SMOOTH);
			}
		}
		//////////////////////////////////////////////////////////////
	...
	static private JMenuItem getTrainMenuItem()
	{
		...
		if (imageURL != null)
		{
			...
			if (withLargeMenu == false) // resize
			{
				imageTrainMenu = imageTrainMenu.getScaledInstance(
					16, 16, java.awt.Image.SCALE_SMOOTH);
			}
		}
		//////////////////////////////////////////////////////////////
	...
	static private JMenuItem getApplyMenuItem()
	{
		...
		if (imageURL != null)
		{
			...
			if (withLargeMenu == false) // resize
			{
				imageApplyMenu = imageApplyMenu.getScaledInstance(
					16, 16, java.awt.Image.SCALE_SMOOTH);
			}
		}
		//////////////////////////////////////////////////////////////
	...
	static private JMenuItem getSaveMenuItem()
	{
		...
		if (imageURL != null)
		{
			...
			if (withLargeMenu == false) // resize
			{
				imageSaveMenu = imageSaveMenu.getScaledInstance(
					16, 16, java.awt.Image.SCALE_SMOOTH);
			}
		}
		//////////////////////////////////////////////////////////////
	...
	static private JMenuItem getColorsMenuItem()
	{
		...
		if (imageURL != null)
		{
			...
			if (withLargeMenu == false) // resize
			{
				imageColorsMenu = imageColorsMenu.getScaledInstance(
					16, 16, java.awt.Image.SCALE_SMOOTH);
			}
		}
		//////////////////////////////////////////////////////////////
	...
	static private JMenuItem getAboutMenuItem()
	{
		...
		// Load image from resource
		URL imageURL = SandBoxClient.class
				.getResource(Constants.resourcePath + "/About.png");
		...
		if (imageURL != null)
		{
			...
			if (withLargeMenu == false) // resize
			{
				imageAboutMenu = imageAboutMenu.getScaledInstance(
					16, 16, java.awt.Image.SCALE_SMOOTH);
			}
		}
		//////////////////////////////////////////////////////////////
	...
	static public IDPXMLTree getJXMLTree() {
		if (jXMLTree == null) {
			...
			/////////////////////////////////////////////////////////////////////////////
			// Listener. Updates the current text coloring in the focused text pane.
	...
	/**
	 * Add tree selectin listener.
	 * public cause is called from other classed
	 */
	...
	static public JSplitPane getJInnerSplitPane() {
		if (jInnerSplitPane == null) {
			...
			//////////////////////////////////////////////////////////////
			// set left component - JTabbedPane, where the data from server is shown
			...
			//////////////////////////////////////////////////////////////
			// add divider listener
			BasicSplitPaneUI paneUI = (BasicSplitPaneUI)jInnerSplitPane.getUI();
			paneUI.getDivider().addMouseListener(new MouseAdapter(){
				@Override
				public void mousePressed(MouseEvent e)
				{
	...
	static private JToolBar getJXMLTreeToolBar() {
		if (jXMLTreeToolBar == null) {
			...
			jXMLTreeToolBar.setLayout(new BoxLayout(jXMLTreeToolBar, BoxLayout.Y_AXIS));
	...
	static public JButton getJToolBarButtonColors() {
		if (jToolBarButtonColors == null) {
			...
			if (imageURL != null)
			{
				...
				imageColors = imageColors.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
	...
	static public JButton getJToolBarButtonAdd() {
		if (jToolBarButtonAdd == null) {
			...
			if (imageURL != null)
			{
				...
				imageAddNew = imageAddNew.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
	...
	static public JButton getJToolBarButtonDelete() {
		if (jToolBarButtonDelete == null) {
			...
			if (imageURL != null)
			{
				...
				imageDelete = imageDelete.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
	...
	static public JButton getJToolBarButtonNewMark() {
		if (jToolBarButtonNewMark == null) {
			...
			if (imageURL != null)
			{
				...
				imageNewMark = imageNewMark.getScaledInstance(
					rec.width, rec.height, java.awt.Image.SCALE_SMOOTH);
			}
			//////////////////////////////////////////////////////////////
			...
			jToolBarButtonSave
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							...
							IDPWindowManager.getJToolBarButtonSave().setEnabled(false);
						}
					});
		}
	...
	static private void setEnabled_XMLTreeToolbar(boolean bEnabled)
	{
		...
		else getJXMLTreeToolBar().setBackground(oldColor);
	}
	//////////////////////////////////////////////////////////////////////
	...
	static private void openConsoleWindow()
	{
	    ...
	    //////////////////////////////////////////////////////////////////
		// put to Hash Map
		// as console window differs from other tabs then we'll create dummy structure
		// with any file (e.g., SandBoxClient.properties - doesn't matter what the file exactly is)
		TextFileInfo dummy = new TextFileInfo(new File(Constants.propertiesFileName));
		dummy.setName("Server Console");
		jTabbedPane.putTabInfo(dummy, jConsoleView);
		//////////////////////////////////////////////////////////////////
			
		jConsoleView.setCursor(new Cursor(Cursor.S_RESIZE_CURSOR));
		jConsoleContent.setCursor(new Cursor(Cursor.S_RESIZE_CURSOR));
	}
	//////////////////////////////////////////////////////////////////////
