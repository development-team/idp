...
public class TextBaseLoader
{
    ...
    private void loadFile(File file) throws IOException, ParseException {
        ...
        //TODO this should be changed to adjusted parameter
        String defaultEncoding = "UTF8";
        //build the correct reader
        BufferedReader in;
        if (documentStyle == DOC_PER_LINE)
	    // in = new LineNumberReader(new FileReader(file));
        	in = new LineNumberReader(new InputStreamReader(new FileInputStream(file), defaultEncoding));
        else
        // fixing not english text bug
        // in = new BufferedReader(new FileReader(file));
        	in =  new BufferedReader(new InputStreamReader(new FileInputStream(file), defaultEncoding));
